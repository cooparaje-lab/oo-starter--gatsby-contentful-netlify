    ...
    <Home>
      <Title className="mb-2">
        <Fade top cascade duration={1200}>
          <FiCodesandbox className="inline-block mb-1 text-white" />
      ...
      <div class="custom-shape-divider-bottom-1594014441">
        <svg
          data-name="Layer 1"
...
const Home = styled.div`
  ${tw`relative flex flex-col items-center justify-center py-6 text-center bg-indigo-400`}
  min-height: 60vh;
