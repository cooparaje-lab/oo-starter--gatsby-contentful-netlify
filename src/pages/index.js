...
const IndexPage = () => (
  <Layout>
    ...
    <Home>
      ...
      <p>Es hora de crear algo grandioso</p>
      <Link
        className="my-3 border-b-2 hover:border-blue-500"
...
const Home = styled.div`
  ${tw`flex flex-col items-center justify-end pt-6 text-center bg-blue-100 border-b border-blue-300 shadow-sm`}
  min-height: 50vh;
