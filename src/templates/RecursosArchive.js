...
const HeroRecurso = styled.div`
  ${tw`flex items-center justify-start w-full py-6 mb-2 text-left bg-indigo-500`}
  ...
  h1 {
    ${tw`w-full max-w-6xl px-8 pt-2 m-auto font-sans text-2xl font-bold text-left text-white`}
  }
